...
# Main function to run tests and create charts
def run_tests_and_plot():
    ...
    # Save data to Excel
    random_df_log.to_excel("random_data_comparisons.xlsx", index=True)
    mostly_sorted_df_log.to_excel("mostly_sorted_data_comparisons.xlsx", index=True)

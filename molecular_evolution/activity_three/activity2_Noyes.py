...
def calculate_Fst(fasta_file, position):
    ...
    ### ************************** ###
    ### *** ADD YOUR CODE HERE *** ###
    Fst = (HT - HS) / HT  # Avoid division by zero
    ### ************************** ###
    ### ************************** ###
...
if __name__ == "__main__":
    ...
    ### *** ADD YOUR CODE HERE *** ###
    if fst_value <= 0.05:
        print("There is no differentiation, the populations are indistiguishable.")
    elif fst_value > 0.05 and fst_value <= 0.15:
        print("There is moderate differentiation.")
    elif fst_value > 0.15 and fst_value <= 0.25:
        print("There is great differentiation.")
    elif fst_value >= 0.25: 
        print("There is very great differentiation, these two populations are very distinguishable.")
    ### ************************** ###
    ### ************************** ###
